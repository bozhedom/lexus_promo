...
export interface Application {
  id: string;
  status: 'draft_plate' | 'draft_car' | 'draft_personal' | 'completed';
  plateNumber?: string | null;
  carBrand?: string | null;
  carModel?: string | null;
  carYear?: number | null;
  carDataSource?: ('api' | 'manual') | null;
  fullName?: string | null;
  phone?: string | null;
  email?: string | null;
  consentGiven?: boolean | null;
  /**
   * Anonymous visitor session id. Guards the application from foreign updates and links analytics events.
   */
...
export interface Certificate {
  ...
  amount: number;
  /**
   * The picture the guest saved. Appears after they hit save.
   */
