...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_applications_status" AS ENUM('draft_plate', 'draft_car', 'draft_personal', 'completed');
  CREATE TYPE "public"."enum_applications_car_data_source" AS ENUM('api', 'manual');
  CREATE TABLE "applications" (
  	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
  	"status" "enum_applications_status" DEFAULT 'draft_plate' NOT NULL,
  	"plate_number" varchar,
  	"car_brand" varchar,
  	"car_model" varchar,
  	"car_year" numeric,
  	"car_data_source" "enum_applications_car_data_source",
  	"full_name" varchar,
  	"phone" varchar,
  	"email" varchar,
  ...
  ALTER TABLE "certificates" ADD CONSTRAINT "certificates_application_id_applications_id_fk" FOREIGN KEY ("application_id") REFERENCES "public"."applications"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "events" ADD CONSTRAINT "events_application_id_applications_id_fk" FOREIGN KEY ("application_id") REFERENCES "public"."applications"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "applications_plate_number_idx" ON "applications" USING btree ("plate_number");
  CREATE INDEX "applications_phone_idx" ON "applications" USING btree ("phone");
  CREATE INDEX "applications_session_id_idx" ON "applications" USING btree ("session_id");
  ...
  CREATE UNIQUE INDEX "certificates_code_idx" ON "certificates" USING btree ("code");
  ...
  CREATE INDEX "events_application_idx" ON "events" USING btree ("application_id");
  CREATE INDEX "events_event_name_idx" ON "events" USING btree ("event_name");
  CREATE INDEX "events_updated_at_idx" ON "events" USING btree ("updated_at");
  CREATE INDEX "events_created_at_idx" ON "events" USING btree ("created_at");
  CREATE INDEX "eventName_createdAt_idx" ON "events" USING btree ("event_name","created_at");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_applications_car_data_source";`)
}
